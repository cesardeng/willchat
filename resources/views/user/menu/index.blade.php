        ...
        @if(count($menuTree) > 0)
          @foreach ($menuTree as $menu)
            <tr>
              ...
              <td>
                <a class="btn btn-primary btn-xs dialog-popup" href="{{ user_url('menu/update/'.$menu->id) }}">编辑</a>
            ...
            @if (count($menu->subButtons) > 0)
              @foreach ($menu->subButtons as $subButton)
                <tr>
                  ...
                  <td>
                    <a class="btn btn-primary btn-xs dialog-popup" href="{{ user_url('menu/update/'.$subButton->id) }}">编辑</a>
